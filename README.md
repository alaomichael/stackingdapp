...
```sh
git clone https://github.com/alaomichael/stackingdapp.git
cd staking-dapp
npm install
```
...
```
to get your staking reward by AMS Token                                                                        Started HTTP and WebSocket JSON-RPC server at http://127.0.0.1:8545/
